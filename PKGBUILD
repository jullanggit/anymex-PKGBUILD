...
source=("${_appimage}::${url}/releases/download/test/${_PkgName}-Linux.AppImage"
        "LICENSE-${pkgver}.md::https://raw.githubusercontent.com/RyanYuuki/AnymeX/refs/tags/test/LICENSE.md")
noextract=(${_appimage})
sha256sums=('03e91af60361c92dc1323d9998878988f054ee6f6a24682a93c5dbcb8ae7334d' 'SKIP')
